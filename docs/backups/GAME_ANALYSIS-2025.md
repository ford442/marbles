...
> **Historical snapshot (early 2025).** This document describes an older build (7 hard-coded levels). For the current catalog and migration policy, see [architecture/level-pipeline.md](architecture/level-pipeline.md).
