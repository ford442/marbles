...
export function createNebulaNexusZone(game, offset) {
    ...
    // --- Low Friction Ice Track Segment ---
    {
        ...
        const { entity } = createVisual(pos, hExtents, [0.2, 0.1, 0.9], 0.0);
    ...
    for (let i = 0; i < platformCount; i++) {
        ...
        const { entity } = createVisual({ x: startX, y: startY, z: zOffset }, hExtents, [0.9, 0.1, 0.2], 0.2);
