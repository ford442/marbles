...
const premiumMarbles = [
    { name: "Starfire Diamond", color: [1.0, 0.4, 0.1], offset: { x: 0.0, y: 5, z: 0 }, radius: 0.7, density: 50.0, restitution: 2.5, gravityScale: 1.0, friction: 0.0, roughness: 0.0, clearCoat: 1.0, clearCoatRoughness: 0.0, materialType: "glass", emissive: true, lightIntensity: 85000.0, lightColor: [1.0, 0.5, 0.2] },
...
export const marblesInfo = [
    ...
    { name: "Hyper-Bouncing Prism", color: [1.0, 0.0, 0.5], offset: { x: 40.0, y: 5, z: 0 }, radius: 1.2, density: 100.0, friction: 0.0, restitution: 2.5, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 80000.0, lightColor: [1.0, 0.0, 0.5], materialType: "glass" },
    ...
    { name: "Chronos Jewel", color: [0.2, 0.8, 1.0], offset: { x: 30.0, y: 5, z: 0 }, radius: 0.9, density: 80.0, friction: 0.0, restitution: 2.5, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 90000.0, lightColor: [0.2, 0.8, 1.0], materialType: "glass" },
