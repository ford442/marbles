...
const premiumMarbles = [
    ...
    { name: "Luminous Titan", color: [0.0, 1.0, 0.8], offset: { x: 0.0, y: 5, z: 30 }, radius: 1.5, density: 400.0, friction: 0.0, restitution: 2.5, gravityScale: 1.0, clearCoat: 1.0, clearCoatRoughness: 0.0, materialType: "glass", emissive: true, lightIntensity: 150000.0, lightColor: [0.0, 1.0, 0.8] }
];
...
export const marblesInfo = [
    ...
    { name: "Ice Slick", color: [0.8, 0.9, 1.0], offset: { x: -5.0, y: 3, z: 0 }, radius: 0.48, friction: 0.005, restitution: 0.8, density: 0.9, roughness: 0.05, materialType: "glass" },
    { name: "Super Bouncy", color: [1.0, 0.0, 0.8], offset: { x: 5.0, y: 3, z: 0 }, radius: 0.52, friction: 0.5, restitution: 1.8, density: 0.5, roughness: 0.2, emissive: true, lightIntensity: 10000.0, lightColor: [1.0, 0.0, 0.8] },
    ...
    { name: "Tiny Dense", color: [1.0, 1.0, 1.0], offset: { x: 3.5, y: 3, z: 4 }, radius: 0.3, density: 10.0, friction: 0.1, restitution: 0.5, roughness: 0.1 },
    ...
    { name: "Neon Core", color: [0.1, 0.1, 0.1], offset: { x: 4.0, y: 3, z: 6 }, radius: 0.5, density: 8.0, friction: 0.3, restitution: 0.4, emissive: true, lightIntensity: 30000.0, lightColor: [0.0, 1.0, 1.0], materialType: "neonGlow" },
    ...
    { name: "Crystal", color: [0.9, 0.9, 1.0], offset: { x: 0.0, y: 5, z: 0 }, radius: 0.5, density: 2.5, friction: 0.1, restitution: 0.6, roughness: 0.05, emissive: true, lightIntensity: 20000.0, lightColor: [0.8, 0.9, 1.0], materialType: "glass" },
    { name: "Ethereal Juggernaut", color: [0.0, 1.0, 0.5], offset: { x: 20.0, y: 5, z: 0 }, radius: 0.8, density: 25.0, friction: 0.0, restitution: 1.2, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 55000.0, lightColor: [0.0, 1.0, 0.5], materialType: "glass" },
    { name: "Hyper-Bouncing Prism", color: [1.0, 0.0, 0.5], offset: { x: 40.0, y: 5, z: 0 }, radius: 1.2, density: 100.0, friction: 0.0, restitution: 2.0, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 80000.0, lightColor: [1.0, 0.0, 0.5], materialType: "glass" },
    ...
    { name: "Supernova", color: [1.0, 0.8, 0.2], offset: { x: -8.0, y: 5, z: -10 }, radius: 0.7, density: 8.0, friction: 0.0, restitution: 1.4, emissive: true, lightIntensity: 60000.0, lightColor: [1.0, 0.7, 0.1], materialType: "volcanicMagma" },
    { name: "Galactic Core", color: [0.2, 0.4, 1.0], offset: { x: 0.0, y: 5, z: 12 }, radius: 0.6, density: 4.0, friction: 0.1, restitution: 1.2, emissive: true, lightIntensity: 55000.0, lightColor: [0.2, 0.5, 1.0], materialType: "galacticCore" },
    ...
    { name: "Aegis Diamond", color: [0.9, 0.95, 1.0], offset: { x: 18.0, y: 5, z: 0 }, radius: 0.6, density: 10.0, friction: 0.0, restitution: 1.8, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 50000.0, lightColor: [0.2, 0.8, 1.0], materialType: "glass" },
    { name: "Omega Titan", color: [1.0, 0.2, 0.3], offset: { x: 20.0, y: 5, z: 0 }, radius: 0.75, density: 30.0, friction: 0.0, restitution: 1.5, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 55000.0, lightColor: [1.0, 0.2, 0.3], materialType: "glass" },
    { name: "Infinity Glass", color: [0.0, 1.0, 0.8], offset: { x: 22.0, y: 5, z: 0 }, radius: 0.8, density: 40.0, friction: 0.0, restitution: 2.0, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 65000.0, lightColor: [0.0, 1.0, 0.8], materialType: "glass" },
    { name: "Quantum Phoenix", color: [1.0, 0.4, 0.0], offset: { x: 24.0, y: 5, z: 0 }, radius: 0.8, density: 15.0, friction: 0.0, restitution: 1.5, gravityScale: 0.8, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 75000.0, lightColor: [1.0, 0.2, 0.1], materialType: "glass" },
    { name: "Nebula Smasher", color: [0.8, 0.0, 1.0], offset: { x: 26.0, y: 5, z: 0 }, radius: 0.85, density: 100.0, friction: 0.0, restitution: 1.8, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 85000.0, lightColor: [0.8, 0.0, 1.0], materialType: "glass" },
    { name: "Cosmic Prism", color: [0.9, 0.1, 0.9], offset: { x: 28.0, y: 5, z: 0 }, radius: 0.85, density: 50.0, friction: 0.0, restitution: 1.5, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 60000.0, lightColor: [0.9, 0.1, 0.9], materialType: "glass" },
    { name: "Chronos Jewel", color: [0.2, 0.8, 1.0], offset: { x: 30.0, y: 5, z: 0 }, radius: 0.9, density: 80.0, friction: 0.0, restitution: 2.0, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 90000.0, lightColor: [0.2, 0.8, 1.0], materialType: "glass" },
    { name: "Starlight Ruby", color: [1.0, 0.2, 0.4], offset: { x: 32.0, y: 5, z: 0 }, radius: 0.7, density: 8.0, friction: 0.0, restitution: 1.8, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 65000.0, lightColor: [1.0, 0.2, 0.4], materialType: "glass" },
    ...
    { name: "Galactic Titan", color: [0.8, 0.2, 1.0], offset: { x: 36.0, y: 5, z: 0 }, radius: 1.0, density: 200.0, friction: 0.0, restitution: 2.0, clearCoat: 1.0, clearCoatRoughness: 0.0, emissive: true, lightIntensity: 100000.0, lightColor: [0.8, 0.2, 1.0], materialType: "glass" },
