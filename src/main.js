...
class MarblesGame {
    ...
    async createZone(zone) {
        ...
        switch (zone.type) {
            ...
            case 'powerup':
                ...
                break;
            case 'space_station':
                this.createSpaceStationZone(offset);
                break;
            case 'moving':
    ...
    createSpaceStationZone(offset) {
        ...
        this.createStaticBox({ x: offset.x - 7.5, y: offset.y + 2, z: offset.z }, floorQ, { x: 0.5, y: 2, z: 8 }, [0.4, 0.4, 0.5], 'metal');
        this.createStaticBox({ x: offset.x + 7.5, y: offset.y + 2, z: offset.z }, floorQ, { x: 0.5, y: 2, z: 8 }, [0.4, 0.4, 0.5], 'metal');
