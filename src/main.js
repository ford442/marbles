...
class MarblesGame {
    ...
    createMarbles(spawnPos) {
        ...
        const marblesInfo = [
            ...
            // 18. Obsidian - Dark, shiny, brittle feel
            { name: "Obsidian", color: [0.05, 0.05, 0.05], offset: { x: 2.5, y: 5, z: -4 }, radius: 0.5, density: 4.0, friction: 0.1, restitution: 0.1, roughness: 0.0 }
        ];
