...
class MarblesGame {
    ...
    createMarbles(spawnPos) {
        ...
        const marblesInfo = [
            ...
            // 11. Mercury Marble - Heavy liquid metal, slippery, low bounce
            { color: [0.75, 0.75, 0.8], offset: { x: 0.0, y: 6, z: 0 }, radius: 0.4, density: 13.0, friction: 0.05, roughness: 0.0, restitution: 0.1 }
        ];
